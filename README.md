...
// You can now use this 'reportContent' variable.
// For example, in a simple web server or a static site generator:
// fs.writeFileSync('index.html', reportContent);
// Or in a simple script to print it to console:
